...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run live safety gate.")
    ...
    parser.add_argument("--name", default="live_safety_latest")

    return parser.parse_args()


def maybe_build_inputs_from_args(args: argparse.Namespace) -> LiveSafetyInputs | None:
    has_override = (
...
def main() -> int:
    ...
    report = build_live_safety_report(inputs=inputs)
    ...
    if args.export:
        ...
        print(f"Live safety report exported: {path}")
