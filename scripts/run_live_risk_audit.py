...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run live risk audit.")
    ...
    parser.add_argument("--name", default="live_risk_audit_demo")
...
def main() -> int:
    ...
    if args.export:
        ...
        print(f"Live risk audit exported: {path}")
